import { addBook, updateBook } from "@/app/api/fetchBook/book";
...
export async function editBook(prevState: FormState, formData: FormData): Promise<FormState> {
  ...
  await updateBook(id, BookName, Author, category, parseInt(Price), BookLink, Image, Description, parseInt(instock), bookId, imageId);
