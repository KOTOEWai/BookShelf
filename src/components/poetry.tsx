...
export default function CategoryPoetry({books}:Props) {
  ...
  return (
    <div className="relative w-full   px-6 py-10">
      <h2 className="text-2xl font-bold mb-6 text-center">ကဗျာ</h2>
             ...
             >
               {books.map((book) => (
                 ...
                 >
                   ...
                   <p className="p-4 text-sm font-semibold bg-emerald-200 ">{book.BookName}</p>
                 </motion.div>
               ))}
             </motion.div>
           </div>
