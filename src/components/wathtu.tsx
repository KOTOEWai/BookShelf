...
export default function CategoryWatthu({ books }: Props) {
  ...
  return (
    <div className="relative w-full px-6 py-10">
      <h2 className="text-2xl font-bold mb-6 text-center">ဝတ္ထု</h2>
      ...
      <div ref={scrollRef} className="overflow-hidden">
        ...
        >
          ...
          { books.map((book) => (
                <motion.div
                  key={book._id}
                  className="min-w-[190px] bg-white rounded-xl shadow-md hover:shadow-lg transition duration-300 text-center"
