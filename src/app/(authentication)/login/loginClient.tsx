...
<section className="bg-gray-100 min-h-screen  flex box-border justify-center items-center">
   ...
   {errorMsg && <span className="text-red-500 text-2xl">{errorMsg}</span>}
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
               
                <input className="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Email" required/>
               
                <div className="relative">
                    <input className="p-2 rounded-xl border w-full" type="password" name="password" id="password" placeholder="Password" required/>
            ...
            <div className="mt-4 text-sm flex justify-between items-center container-mr">
                ...
                <Link href={'/register'} className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Register</Link>
            </div>
        </div>
        <div className="md:block hidden w-1/2">
            <Image className="rounded-2xl " src={photo} width={500} alt="login form image"/>
        </div>
    </div>
</section>
</>
